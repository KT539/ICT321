...
const seed = async () => {
    console.log("🚀 Début de l’insertion des données étendues...\n");

    // Fonction utilitaire pour exécuter du SQL avec une Promise
    ...
    try {
        ...
        // 2. INSERTION DES 10 INGRÉDIENTS
        const ingredientNames = [
            "Tomate", "Mozzarella", "Jambon", "Champignons", "Basilic",
            "Chèvre", "Miel", "Salami Piquant", "Olives", "Roquette"
        ];
        const ingredientIds = {};
        ...
        console.log("🍅 10 Ingrédients insérés !");

        // 3. DÉFINITION DES 5 PIZZAS
        const pizzas = [
            {
                name: "Margherita",
            ...
            {
                name: "Reine",
                description: "Un indémodable aux champignons et jambon blanc.",
            ...
            {
                name: "Biquette",
                description: "Le mélange sucré-salé parfait chèvre et miel.",
                imageUrl: "/images/biquette.jpg",
                price: 15.00,
                ingredients: ["Mozzarella", "Chèvre", "Miel", "Roquette"]
            },
            {
                name: "Végétarienne",
                description: "Le jardin potager sur une pâte croustillante.",
        ...
        console.log("🍕 5 Pizzas et leurs liens ingrédients insérés !");

        // 4. INSERTION DES 3 PROMOTIONS
        // On récupère les IDs via le nom pour être sûr
        ...
        console.log("🔥 3 Promotions insérées !");
        console.log("\n✅ Base de données initialisée avec succès !");

    } catch (err) {
        console.error("❌ Erreur lors du seeding :", err);
    } finally {
        // Pas besoin de fermer la db ici si elle est gérée par le process
    }
};
